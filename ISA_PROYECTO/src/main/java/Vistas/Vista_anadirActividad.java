...
public class Vista_anadirActividad extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int aforo = Integer.parseInt(jTextField3.getText());
        int sala = Integer.parseInt(jTextField4.getText());
        
        controlador.añadir_actividad(id,tipo,hora,aforo,sala);
        controlador.actualizar_actividades();
